...
This portfolio is adapted from Bruno Simon's Folio 2025 project. The original MIT license is retained in [license.md](./license.md), and additional attribution is provided in [CREDITS.md](./CREDITS.md).
...
This is a static Vite site and runs on Cloudflare Pages' free plan. Import the `HarshitN87/portfolio` repository, select the `main` branch, then use:

- Build command: `npm run build`
- Build output directory: `dist`

The committed [wrangler.jsonc](./wrangler.jsonc) also supports direct deployment after logging in to Cloudflare: `npx wrangler pages deploy dist`.
